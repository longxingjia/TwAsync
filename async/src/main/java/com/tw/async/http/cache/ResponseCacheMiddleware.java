package com.tw.async.http.cache;
...
public class ResponseCacheMiddleware extends SimpleMiddleware {
    ...
    public static ResponseCacheMiddleware addCache(TwAsyncHttpClient client, File cacheDir, long size) throws IOException {
    ...
    public void onBodyDecoder(OnBodyDecoderData data) {
        CachedSocket cached = com.tw.async.Util.getWrappedSocket(data.socket, CachedSocket.class);
        if (cached != null) {
        ...
        private Certificate[] readCertArray(StrictLineReader reader) throws IOException {
            ...
            try {
                ...
                for (int i = 0; i < result.length; i++) {
                    ...
                    byte[] bytes = Base64Util.decode(line, Base64Util.DEFAULT);
        ...
        private void writeCertArray(Writer writer, Certificate[] certificates) throws IOException {
            ...
            try {
                ...
                for (Certificate certificate : certificates) {
                    ...
                    String line = Base64Util.encodeToString(bytes, Base64Util.DEFAULT);
                    writer.write(line + '\n');
                }
