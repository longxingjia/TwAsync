...
public class AsyncSSLSocketMiddleware extends AsyncSocketMiddleware {
    public AsyncSSLSocketMiddleware(TwAsyncHttpClient client) {
    ...
    protected void tryHandshake(AsyncSocket socket, GetSocketData data, final Uri uri, final int port, final ConnectCallback callback) {
        AsyncSSLSocketWrapper.handshake(socket, uri.getDecodedHost(), port,
        createConfiguredSSLEngine(data, uri.getDecodedHost(), port),
